    ...
    public void afterPropertiesSet() throws IOException {
        ...
        annotatedClasses.forEach(clazz -> {
            ...
            try {
                ...
                o = beanFactory.createBean(ProviderProxyFactory.getInstance().defineGenericClass(getEntityProviderName(), clazz, genericType), AutowireCapableBeanFactory.AUTOWIRE_BY_TYPE, false);
                beanFactory.registerSingleton(o.getClass().getName(), o);
            } catch (Exception e) {
                e.printStackTrace();
            }
